...
namespace Azure.StorageServices {
  public sealed class StorageServiceClient : RestClient {
    ...
    public StorageServiceClient(string url, string accessKey, string version = "2019-12-12", string account = "") : base(url) {
    ...
    /// <summary>
    /// Creates a new instance of the <see cref="Unity3dAzure.StorageServices.StorageServiceClient"/> sealed class.
    /// </summary>
    /// <param name="account">Storage account name.</param>
    /// <param name="accessKey">Access key.</param>
    public static StorageServiceClient Create(string account, string accessKey, string version = "2019-12-12") {
