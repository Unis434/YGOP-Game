...
namespace Doozy.Engine.UI.Nodes
{
    ...
    public class LoadSceneNode : Node
    {
        ...
        public bool NextNodeOnFinish = false;
        ...
        public override void OnEnter(Node previousActiveNode, Connection connection)
        {
            ...
            LoadScene();
            if (NextNodeOnFinish || !FirstOutputSocket.IsConnected) return;
        ...
        private void LoadScene()
        {
            ...
            if (NextNodeOnFinish && FirstOutputSocket.IsConnected)
                loader.SetOnSceneLoaded(() => ActiveGraph.SetActiveNodeByConnection(FirstOutputSocket.FirstConnection));
