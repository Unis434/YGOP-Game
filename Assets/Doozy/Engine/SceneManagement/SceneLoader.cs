...
namespace Doozy.Engine.SceneManagement
{
    ...
    public class SceneLoader : MonoBehaviour
    {
        ...
        protected System.Action OnSceneLoaded;
        ...
        public AsyncOperationWrapper CurrentAsyncOperation { get; private set; }
...
//            Debug.Log("CurrentAsyncOperation == null? " + (CurrentAsyncOperation == null));
        ...
        public void LoadSceneAsync()
        {
            ...
            switch (GetSceneBy)
            {
                ...
                case GetSceneBy.BuildIndex:
                    ...
                    break;
                case GetSceneBy.GameManager:
                    LoadSceneAsync(Game.Manager.NextScene, LoadSceneMode);
                    break;
            }
        }
        ...
        public Progressor LoadSceneAsync(int sceneBuildIndex, LoadSceneMode mode)
        {
            ...
            CurrentAsyncOperation = Game.App.LoadScene(sceneBuildIndex, mode, false);
            StartSceneLoad();
            return Progressor;
        }
        ...
        public Progressor LoadSceneAsync(string sceneName, LoadSceneMode mode)
        {
            ResetProgress();
            LoadBehavior.OnLoadScene.Invoke(gameObject);
            CurrentAsyncOperation = Game.App.LoadScene(sceneName, mode, false);
            StartSceneLoad();
            return Progressor;
        }
        ...
        public SceneLoader SetOnSceneLoaded(System.Action onSceneLoaded)
        {
